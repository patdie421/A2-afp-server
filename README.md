...
* AFP file sharing over ethertalk (conversion to localtalk must be done with "LocalTalk Bridge 2.1" or hardware solution like "AsanteTalk ethernet-serial LocalTalk bridge" or "Farallon EtherMac iPrint")
